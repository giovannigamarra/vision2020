  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        Editar Expositor
        <small>Utilice el formulario para editar un expositor</small>
      </h1>
    </section>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Información del Expositor</h3>
                            </div>
                            <!-- /.box-header -->
                                <?php 
                                ...
                                <form role="form" id="guardar-registro-archivo" action="modelo-invitado.php" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nombre_invitado" name="nombre_invitado" placeholder="Nombre" value="
                                                <?php echo $invitado['nombre_invitado']; ?>">
                                            </div>  
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="biografia_invitado" name="biografia_invitado" placeholder="Biografia" rows="8">
                                                <?php echo $invitado['descripcion']; ?></textarea>
                                            </div> 
