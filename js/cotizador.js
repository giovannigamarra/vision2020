...
(function() {
  ...
  if(document.getElementById('calcular')) {
        ...
        // Campos pases
        var pase_dia =document.getElementById('Alumnos(USMP)');
        var pase_dosdias =document.getElementById('Externos');
        var pase_completo =document.getElementById('Ex-Alumnos(USMP)');
        ...
        function calcularMontos(event){
            ...
            if(regalo.value === '') {
              ...
              if(boletosDia >= 1) {
                listadoProductos.push(boletosDia + ' Alumnos(USMP)');
              }
              if(boletos2Dias >= 1) {
                listadoProductos.push(boletos2Dias + ' Externos');
              }
              if(boletoCompleto >= 1) {
                listadoProductos.push(boletoCompleto + ' Ex-Alumnos(USMP)');
              }
              if(cantCamisas >= 1) {
        ...
        function mostrarDias(){
          var boletosDia = parseInt(pase_dia.value, 10)|| 0,
              ...
              if(boletosDia > 0){
                diasElegidos.push('jueves','viernes');
